...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RewardPricing = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The RewardPricing model module.
   * @module model/RewardPricing
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardPricing</code>.
   * Reward Item pricing details
   * @alias module:model/RewardPricing
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardPricing</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardPricing} obj Optional instance to populate.
   * @return {module:model/RewardPricing} The populated <code>RewardPricing</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('pointPrice')) {
        obj['pointPrice'] = Amount.constructFromObject(data['pointPrice']);
      }
      if (data.hasOwnProperty('faceValue')) {
        obj['faceValue'] = Amount.constructFromObject(data['faceValue']);
      }
      if (data.hasOwnProperty('additionalPayment')) {
        obj['additionalPayment'] = Amount.constructFromObject(data['additionalPayment']);
      }
    }
    return obj;
  }
   ...
   * @member {module:model/Amount} pointPrice
   */
  exports.prototype['pointPrice'] = undefined;
  /**
   * Actual value of the Reward item
   * @member {module:model/Amount} faceValue
   */
  exports.prototype['faceValue'] = undefined;
  /**
   * Additional cash payment needed to redeem
   * @member {module:model/Amount} additionalPayment
   */
  exports.prototype['additionalPayment'] = undefined;
