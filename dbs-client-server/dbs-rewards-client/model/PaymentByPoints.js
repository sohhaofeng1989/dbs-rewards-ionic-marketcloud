...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PaymentByPoints = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The PaymentByPoints model module.
   * @module model/PaymentByPoints
   * @version 1.0
   */

  /**
   * Constructs a new <code>PaymentByPoints</code>.
   * Results of payment with Reward points
   * @alias module:model/PaymentByPoints
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentByPoints</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentByPoints} obj Optional instance to populate.
   * @return {module:model/PaymentByPoints} The populated <code>PaymentByPoints</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('redeemedAmount')) {
        obj['redeemedAmount'] = Amount.constructFromObject(data['redeemedAmount']);
      }
      ...
      if (data.hasOwnProperty('remainingCashValue')) {
        obj['remainingCashValue'] = Amount.constructFromObject(data['remainingCashValue']);
      }
    }
    return obj;
  }
  ...
  /**
   * Transaction Reference identifier for payment of remaining bill amount.
   * @member {String} referenceId
   */
  exports.prototype['referenceId'] = undefined;
  /**
   * Amount that has been redeemed
   * @member {module:model/Amount} redeemedAmount
   */
  exports.prototype['redeemedAmount'] = undefined;
  /**
  ...
  /**
   * Cash value that is remaining
   * @member {module:model/Amount} remainingCashValue
   */
