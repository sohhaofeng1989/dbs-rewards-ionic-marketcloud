...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PaymentByRebates = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The PaymentByRebates model module.
   * @module model/PaymentByRebates
   * @version 1.0
   */

  /**
   * Constructs a new <code>PaymentByRebates</code>.
   * Results of payment with Daily$
   * @alias module:model/PaymentByRebates
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentByRebates</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentByRebates} obj Optional instance to populate.
   * @return {module:model/PaymentByRebates} The populated <code>PaymentByRebates</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('remainingRebates')) {
        obj['remainingRebates'] = Amount.constructFromObject(data['remainingRebates']);
      }
    }
    return obj;
  }
  ...
  /**
   * Daily$ balance that is remaining
   * @member {module:model/Amount} remainingRebates
   */
  exports.prototype['remainingRebates'] = undefined;
