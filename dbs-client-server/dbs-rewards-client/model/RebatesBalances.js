...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RebatesBalances = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RebatesBalances model module.
   * @module model/RebatesBalances
   * @version 1.0
   */

  /**
   * Constructs a new <code>RebatesBalances</code>.
   * Rewards Rebates Balances
   * @alias module:model/RebatesBalances
   * @class
   */
  ...
  /**
   * Constructs a <code>RebatesBalances</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RebatesBalances} obj Optional instance to populate.
   * @return {module:model/RebatesBalances} The populated <code>RebatesBalances</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('adjustedInValue')) {
        obj['adjustedInValue'] = ApiClient.convertToType(data['adjustedInValue'], 'Number');
      }
      if (data.hasOwnProperty('adjustedOutValue')) {
        obj['adjustedOutValue'] = ApiClient.convertToType(data['adjustedOutValue'], 'Number');
      }
      if (data.hasOwnProperty('expiredValue')) {
        obj['expiredValue'] = ApiClient.convertToType(data['expiredValue'], 'String');
      }
    }
    return obj;
  }
   ...
   */
  exports.prototype['previousBalance'] = undefined;
  /**
   * Current balance eligible for redemption
   * @member {Number} currentBalance
   */
  exports.prototype['currentBalance'] = undefined;
  /**
   * Rebates value earned since last statement
   * @member {Number} earnedValue
   */
  exports.prototype['earnedValue'] = undefined;
  /**
   * Rebates value redeemed since last statement
   * @member {Number} redeemedValue
   */
  exports.prototype['redeemedValue'] = undefined;
  /**
   * Adjusted in value since last statement
   * @member {Number} adjustedInValue
   */
  exports.prototype['adjustedInValue'] = undefined;
  /**
   * Adjusted out value since last statement
   * @member {Number} adjustedOutValue
   */
  exports.prototype['adjustedOutValue'] = undefined;
  /**
   * Rebates value that have expired since last statement
   * @member {String} expiredValue
   */
  exports.prototype['expiredValue'] = undefined;
