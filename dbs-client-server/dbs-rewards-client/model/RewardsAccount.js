...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RewardsAccountConversionRates', 'model/RewardsAccountRewardsScheme'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RewardsAccountConversionRates'), require('./RewardsAccountRewardsScheme'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.RewardsAccount = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RewardsAccountConversionRates, root.RewardsApIs.RewardsAccountRewardsScheme);
  }
}(this, function(ApiClient, RewardsAccountConversionRates, RewardsAccountRewardsScheme) {
  'use strict';
  ...
  /**
   * The RewardsAccount model module.
   * @module model/RewardsAccount
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsAccount</code>.
   * Rewards account details
   * @alias module:model/RewardsAccount
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsAccount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsAccount} obj Optional instance to populate.
   * @return {module:model/RewardsAccount} The populated <code>RewardsAccount</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rewardsScheme')) {
        obj['rewardsScheme'] = RewardsAccountRewardsScheme.constructFromObject(data['rewardsScheme']);
      }
      if (data.hasOwnProperty('conversionRates')) {
        obj['conversionRates'] = RewardsAccountConversionRates.constructFromObject(data['conversionRates']);
      }
    }
    return obj;
  }
  ...
  /**
   * Card Description.  Eg. DBS Black Card, POSB Everyday Card
   * @member {String} cardDescription
   */
  exports.prototype['cardDescription'] = undefined;
  /**
   * @member {module:model/RewardsAccountRewardsScheme} rewardsScheme
   */
  exports.prototype['rewardsScheme'] = undefined;
  /**
   * @member {module:model/RewardsAccountConversionRates} conversionRates
   */
  exports.prototype['conversionRates'] = undefined;
