...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.ReversalRequestRedeemAmount = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The ReversalRequestRedeemAmount model module.
   * @module model/ReversalRequestRedeemAmount
   * @version 1.0
   */

  /**
   * Constructs a new <code>ReversalRequestRedeemAmount</code>.
   * Amount redeemed
   * @alias module:model/ReversalRequestRedeemAmount
   * @class
   */
  ...
  /**
   * Constructs a <code>ReversalRequestRedeemAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReversalRequestRedeemAmount} obj Optional instance to populate.
   * @return {module:model/ReversalRequestRedeemAmount} The populated <code>ReversalRequestRedeemAmount</code> instance.
   */
