...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PartyName = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The PartyName model module.
   * @module model/PartyName
   * @version 1.0
   */

  /**
   * Constructs a new <code>PartyName</code>.
   * Party&#39;&#39;&#39;&#39;s Name
   * @alias module:model/PartyName
   * @class
   */
  ...
  /**
   * Constructs a <code>PartyName</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PartyName} obj Optional instance to populate.
   * @return {module:model/PartyName} The populated <code>PartyName</code> instance.
   */
