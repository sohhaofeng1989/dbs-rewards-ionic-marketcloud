...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RedemptionOutlet = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RedemptionOutlet model module.
   * @module model/RedemptionOutlet
   * @version 1.0
   */

  /**
   * Constructs a new <code>RedemptionOutlet</code>.
   * Reward redemption outlet details
   * @alias module:model/RedemptionOutlet
   * @class
   */
  ...
  /**
   * Constructs a <code>RedemptionOutlet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RedemptionOutlet} obj Optional instance to populate.
   * @return {module:model/RedemptionOutlet} The populated <code>RedemptionOutlet</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('outletName')) {
        obj['outletName'] = ApiClient.convertToType(data['outletName'], 'String');
      }
  ...
  /**
   * Name of the outlet to redeem the reward item
   * @member {String} outletName
   */
  exports.prototype['outletName'] = undefined;
  /**
