...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RebatesRedemptionRequest = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RedemptionDetl);
  }
  ...
  /**
   * The RebatesRedemptionRequest model module.
   * @module model/RebatesRedemptionRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>RebatesRedemptionRequest</code>.
   * Reward Redemption request
   * @alias module:model/RebatesRedemptionRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>RebatesRedemptionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RebatesRedemptionRequest} obj Optional instance to populate.
   * @return {module:model/RebatesRedemptionRequest} The populated <code>RebatesRedemptionRequest</code> instance.
   */
