...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.MilesRedemptionResult = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The MilesRedemptionResult model module.
   * @module model/MilesRedemptionResult
   * @version 1.0
   */

  /**
   * Constructs a new <code>MilesRedemptionResult</code>.
   * Redemption result details
   * @alias module:model/MilesRedemptionResult
   * @class
   */
  ...
  /**
   * Constructs a <code>MilesRedemptionResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MilesRedemptionResult} obj Optional instance to populate.
   * @return {module:model/MilesRedemptionResult} The populated <code>MilesRedemptionResult</code> instance.
   */
