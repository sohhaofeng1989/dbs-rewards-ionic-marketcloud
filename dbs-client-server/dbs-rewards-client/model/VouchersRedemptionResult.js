...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/VoucherDetl'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VoucherDetl'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.VouchersRedemptionResult = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.VoucherDetl);
  }
}(this, function(ApiClient, VoucherDetl) {
  'use strict';
  ...
  /**
   * The VouchersRedemptionResult model module.
   * @module model/VouchersRedemptionResult
   * @version 1.0
   */

  /**
   * Constructs a new <code>VouchersRedemptionResult</code>.
   * Redemption result details
   * @alias module:model/VouchersRedemptionResult
   * @class
   */
  ...
  /**
   * Constructs a <code>VouchersRedemptionResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VouchersRedemptionResult} obj Optional instance to populate.
   * @return {module:model/VouchersRedemptionResult} The populated <code>VouchersRedemptionResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('vouchersList')) {
        obj['vouchersList'] = ApiClient.convertToType(data['vouchersList'], [VoucherDetl]);
      }
    }
    return obj;
  }
  ...
  /**
   * Redemption Order reference number for redemption request
   * @member {String} orderId
   */
  exports.prototype['orderId'] = undefined;
  /**
   * Redemption Vouchers
   * @member {Array.<module:model/VoucherDetl>} vouchersList
   */
  exports.prototype['vouchersList'] = undefined;
