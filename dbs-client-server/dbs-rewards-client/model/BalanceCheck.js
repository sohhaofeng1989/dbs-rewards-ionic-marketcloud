...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.BalanceCheck = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The BalanceCheck model module.
   * @module model/BalanceCheck
   * @version 1.0
   */

  /**
   * Constructs a new <code>BalanceCheck</code>.
   * Results of balance check before redemption request
   * @alias module:model/BalanceCheck
   * @class
   */
  ...
  /**
   * Constructs a <code>BalanceCheck</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BalanceCheck} obj Optional instance to populate.
   * @return {module:model/BalanceCheck} The populated <code>BalanceCheck</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('minimumRedeemableAmount')) {
        obj['minimumRedeemableAmount'] = Amount.constructFromObject(data['minimumRedeemableAmount']);
      }
      if (data.hasOwnProperty('totalRedeemableAmount')) {
        obj['totalRedeemableAmount'] = Amount.constructFromObject(data['totalRedeemableAmount']);
      }
  ...
  /**
   * Indicates whether or not the balance is sufficient to cover the requested Amount.
   * @member {Boolean} isSufficient
   */
  exports.prototype['isSufficient'] = undefined;
  /**
   * Minimum Amount that can be redeemed for the Rewards scheme. This will be populated only when balance is not zero.
   * @member {module:model/Amount} minimumRedeemableAmount
   */
  exports.prototype['minimumRedeemableAmount'] = undefined;
  /**
   * Total cash value balance that can be redeemed. This will be populated only when balance is insufficient to cover the requested amount.
   * @member {module:model/Amount} totalRedeemableAmount
   */
  exports.prototype['totalRedeemableAmount'] = undefined;
  /**
   * Total DBS Points balance that can be redeemed. This will be populated only when balance is insufficient to cover the requested amount.
