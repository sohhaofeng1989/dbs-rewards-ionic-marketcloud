...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RewardsExchangeRate = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RewardsExchangeRate model module.
   * @module model/RewardsExchangeRate
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsExchangeRate</code>.
   * Reward redemption outlet details
   * @alias module:model/RewardsExchangeRate
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsExchangeRate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsExchangeRate} obj Optional instance to populate.
   * @return {module:model/RewardsExchangeRate} The populated <code>RewardsExchangeRate</code> instance.
   */
