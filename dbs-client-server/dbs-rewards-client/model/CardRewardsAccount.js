...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RewardsScheme'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RewardsScheme'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.CardRewardsAccount = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RewardsScheme);
  }
}(this, function(ApiClient, RewardsScheme) {
  'use strict';
  ...
  /**
   * The CardRewardsAccount model module.
   * @module model/CardRewardsAccount
   * @version 1.0
   */

  /**
   * Constructs a new <code>CardRewardsAccount</code>.
   * Card rewards account details
   * @alias module:model/CardRewardsAccount
   * @class
   */
  ...
  /**
   * Constructs a <code>CardRewardsAccount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CardRewardsAccount} obj Optional instance to populate.
   * @return {module:model/CardRewardsAccount} The populated <code>CardRewardsAccount</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rewardsSchemes')) {
        obj['rewardsSchemes'] = ApiClient.convertToType(data['rewardsSchemes'], [RewardsScheme]);
      }
    }
    return obj;
  }
  ...
  /**
   * Rewards schemes
   * @member {Array.<module:model/RewardsScheme>} rewardsSchemes
   */
  exports.prototype['rewardsSchemes'] = undefined;
