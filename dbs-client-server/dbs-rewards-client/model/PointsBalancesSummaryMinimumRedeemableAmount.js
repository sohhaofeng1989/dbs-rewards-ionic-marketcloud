...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PointsBalancesSummaryMinimumRedeemableAmount = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The PointsBalancesSummaryMinimumRedeemableAmount model module.
   * @module model/PointsBalancesSummaryMinimumRedeemableAmount
   * @version 1.0
   */

  /**
   * Constructs a new <code>PointsBalancesSummaryMinimumRedeemableAmount</code>.
   * Minimum Amount that can be redeemed for Points scheme. This will be populated if query amount is not present or exceeds the balance.
   * @alias module:model/PointsBalancesSummaryMinimumRedeemableAmount
   * @class
   */
  ...
  /**
   * Constructs a <code>PointsBalancesSummaryMinimumRedeemableAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PointsBalancesSummaryMinimumRedeemableAmount} obj Optional instance to populate.
   * @return {module:model/PointsBalancesSummaryMinimumRedeemableAmount} The populated <code>PointsBalancesSummaryMinimumRedeemableAmount</code> instance.
   */
