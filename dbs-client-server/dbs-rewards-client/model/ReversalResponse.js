...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReversalResponseRewardsBalance'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReversalResponseRewardsBalance'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.ReversalResponse = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.ReversalResponseRewardsBalance);
  }
}(this, function(ApiClient, ReversalResponseRewardsBalance) {
  'use strict';
   ...
   * Results of redemption reversal of Reward points and Daily$
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rewardsBalance')) {
        obj['rewardsBalance'] = ReversalResponseRewardsBalance.constructFromObject(data['rewardsBalance']);
      }
    }
    return obj;
  }
  ...
  /**
   * Reference identifier for the redemption reversal.
   * @member {String} reversalReferenceId
   */
  exports.prototype['reversalReferenceId'] = undefined;
  /**
   * @member {module:model/ReversalResponseRewardsBalance} rewardsBalance
   */
  exports.prototype['rewardsBalance'] = undefined;
