...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CardRewardsAccount'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CardRewardsAccount'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.Rewards = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.CardRewardsAccount);
  }
}(this, function(ApiClient, CardRewardsAccount) {
  'use strict';
  ...
  /**
   * The Rewards model module.
   * @module model/Rewards
   * @version 1.0
   */

  /**
   * Constructs a new <code>Rewards</code>.
   * @alias module:model/Rewards
   * @class
   */
  ...
  /**
   * Constructs a <code>Rewards</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Rewards} obj Optional instance to populate.
   * @return {module:model/Rewards} The populated <code>Rewards</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('cardRewardsAccounts')) {
        obj['cardRewardsAccounts'] = ApiClient.convertToType(data['cardRewardsAccounts'], [CardRewardsAccount]);
      }
    }
    return obj;
  }
  ...
  /**
   * Card rewards accounts
   * @member {Array.<module:model/CardRewardsAccount>} cardRewardsAccounts
   */
  exports.prototype['cardRewardsAccounts'] = undefined;
