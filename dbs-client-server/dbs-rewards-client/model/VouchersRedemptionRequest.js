...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RedemptionDetl'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RedemptionDetl'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.VouchersRedemptionRequest = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RedemptionDetl);
  }
}(this, function(ApiClient, RedemptionDetl) {
  'use strict';
  ...
  /**
   * The VouchersRedemptionRequest model module.
   * @module model/VouchersRedemptionRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>VouchersRedemptionRequest</code>.
   * Reward Redemption request
   * @alias module:model/VouchersRedemptionRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>VouchersRedemptionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VouchersRedemptionRequest} obj Optional instance to populate.
   * @return {module:model/VouchersRedemptionRequest} The populated <code>VouchersRedemptionRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('rewardAccountId')) {
        obj['rewardAccountId'] = ApiClient.convertToType(data['rewardAccountId'], 'String');
      }
      if (data.hasOwnProperty('schemeId')) {
        obj['schemeId'] = ApiClient.convertToType(data['schemeId'], 'String');
      }
      if (data.hasOwnProperty('isCollatable')) {
        obj['isCollatable'] = ApiClient.convertToType(data['isCollatable'], 'String');
      }
      if (data.hasOwnProperty('redemptionList')) {
        obj['redemptionList'] = ApiClient.convertToType(data['redemptionList'], [RedemptionDetl]);
      }
    }
    return obj;
  }
  ...
  /**
   * Reward Account Identifier.
   * @member {String} rewardAccountId
   */
  exports.prototype['rewardAccountId'] = undefined;
  /**
   * Reward Scheme Identifier. Ex: Daily$, DBS Points, Air Miles etc.
   * @member {String} schemeId
   */
  exports.prototype['schemeId'] = undefined;
  /**
   * Indicates whether the redemption items can be collated together into one reward item. Ex: 3 vouchers of $10 each can be redeemed as one $30 voucher
   * @member {String} isCollatable
   */
  exports.prototype['isCollatable'] = undefined;
  /**
   * Redemption item list
   * @member {Array.<module:model/RedemptionDetl>} redemptionList
   */
  exports.prototype['redemptionList'] = undefined;
