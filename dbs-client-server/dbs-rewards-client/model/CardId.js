...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.CardId = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The CardId model module.
   * @module model/CardId
   * @version 1.0
   */

  /**
   * Constructs a new <code>CardId</code>.
   * Tokenized Card Identifier
   * @alias module:model/CardId
   * @class
   */
  ...
  /**
   * Constructs a <code>CardId</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CardId} obj Optional instance to populate.
   * @return {module:model/CardId} The populated <code>CardId</code> instance.
   */
