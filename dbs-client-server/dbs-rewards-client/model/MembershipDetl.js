...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PartyName'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PartyName'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.MembershipDetl = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.PartyName);
  }
}(this, function(ApiClient, PartyName) {
  'use strict';
  ...
  /**
   * The MembershipDetl model module.
   * @module model/MembershipDetl
   * @version 1.0
   */

  /**
   * Constructs a new <code>MembershipDetl</code>.
   * Membership program details to redeem Reward
   * @alias module:model/MembershipDetl
   * @class
   */
  ...
  /**
   * Constructs a <code>MembershipDetl</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MembershipDetl} obj Optional instance to populate.
   * @return {module:model/MembershipDetl} The populated <code>MembershipDetl</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('partyName')) {
        obj['partyName'] = PartyName.constructFromObject(data['partyName']);
      }
    }
    return obj;
  }
  ...
  /**
   * Name as per the Membership program
   * @member {module:model/PartyName} partyName
   */
  exports.prototype['partyName'] = undefined;
