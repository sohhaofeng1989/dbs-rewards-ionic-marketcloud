...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.ReversalResponseRewardsBalanceRemainingCashValue = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The ReversalResponseRewardsBalanceRemainingCashValue model module.
   * @module model/ReversalResponseRewardsBalanceRemainingCashValue
   * @version 1.0
   */

  /**
   * Constructs a new <code>ReversalResponseRewardsBalanceRemainingCashValue</code>.
   * Cash value of the points or rebates remaining
   * @alias module:model/ReversalResponseRewardsBalanceRemainingCashValue
   * @class
   */
  ...
  /**
   * Constructs a <code>ReversalResponseRewardsBalanceRemainingCashValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReversalResponseRewardsBalanceRemainingCashValue} obj Optional instance to populate.
   * @return {module:model/ReversalResponseRewardsBalanceRemainingCashValue} The populated <code>ReversalResponseRewardsBalanceRemainingCashValue</code> instance.
   */
