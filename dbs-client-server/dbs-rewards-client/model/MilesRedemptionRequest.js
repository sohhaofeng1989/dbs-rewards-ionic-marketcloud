...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MembershipDetl'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MembershipDetl'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.MilesRedemptionRequest = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.MembershipDetl);
  }
}(this, function(ApiClient, MembershipDetl) {
  'use strict';
  ...
  /**
   * The MilesRedemptionRequest model module.
   * @module model/MilesRedemptionRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>MilesRedemptionRequest</code>.
   * Reward Redemption request
   * @alias module:model/MilesRedemptionRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>MilesRedemptionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MilesRedemptionRequest} obj Optional instance to populate.
   * @return {module:model/MilesRedemptionRequest} The populated <code>MilesRedemptionRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('redeemQuantity')) {
        obj['redeemQuantity'] = ApiClient.convertToType(data['redeemQuantity'], 'Number');
      }
      if (data.hasOwnProperty('membershipDetl')) {
        obj['membershipDetl'] = MembershipDetl.constructFromObject(data['membershipDetl']);
      }
    }
    return obj;
  }
  ...
  /**
   * Quantity of items to be redeemed
   * @member {Number} redeemQuantity
   */
  exports.prototype['redeemQuantity'] = undefined;
  /**
   * Reward redemption to a Membership program account
   * @member {module:model/MembershipDetl} membershipDetl
   */
  exports.prototype['membershipDetl'] = undefined;
