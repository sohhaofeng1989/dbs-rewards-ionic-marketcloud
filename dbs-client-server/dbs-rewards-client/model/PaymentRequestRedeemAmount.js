...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PaymentRequestRedeemAmount = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The PaymentRequestRedeemAmount model module.
   * @module model/PaymentRequestRedeemAmount
   * @version 1.0
   */

  /**
   * Constructs a new <code>PaymentRequestRedeemAmount</code>.
   * Amount to be redeemed
   * @alias module:model/PaymentRequestRedeemAmount
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentRequestRedeemAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentRequestRedeemAmount} obj Optional instance to populate.
   * @return {module:model/PaymentRequestRedeemAmount} The populated <code>PaymentRequestRedeemAmount</code> instance.
   */
