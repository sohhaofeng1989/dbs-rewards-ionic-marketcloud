...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RedemptionDetl = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RedemptionDetl model module.
   * @module model/RedemptionDetl
   * @version 1.0
   */

  /**
   * Constructs a new <code>RedemptionDetl</code>.
   * Reward Redemption details
   * @alias module:model/RedemptionDetl
   * @class
   */
  ...
  /**
   * Constructs a <code>RedemptionDetl</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RedemptionDetl} obj Optional instance to populate.
   * @return {module:model/RedemptionDetl} The populated <code>RedemptionDetl</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('redeemAmount')) {
        obj['redeemAmount'] = ApiClient.convertToType(data['redeemAmount'], 'Number');
      }
    }
    return obj;
  }
