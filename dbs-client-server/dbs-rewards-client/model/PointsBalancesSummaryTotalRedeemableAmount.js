...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PointsBalancesSummaryTotalRedeemableAmount = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The PointsBalancesSummaryTotalRedeemableAmount model module.
   * @module model/PointsBalancesSummaryTotalRedeemableAmount
   * @version 1.0
   */

  /**
   * Constructs a new <code>PointsBalancesSummaryTotalRedeemableAmount</code>.
   * Total cash value amount equivalent that can be redeemed for Points scheme. This will be populated if query amount is not present or exceeds the balance.
   * @alias module:model/PointsBalancesSummaryTotalRedeemableAmount
   * @class
   */
  ...
  /**
   * Constructs a <code>PointsBalancesSummaryTotalRedeemableAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PointsBalancesSummaryTotalRedeemableAmount} obj Optional instance to populate.
   * @return {module:model/PointsBalancesSummaryTotalRedeemableAmount} The populated <code>PointsBalancesSummaryTotalRedeemableAmount</code> instance.
   */
