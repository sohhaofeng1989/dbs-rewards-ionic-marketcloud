...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.ExpiryDate = factory(root.RewardsApIs.ApiClient);
  }
   ...
   * @param {module:model/ExpiryDate} obj Optional instance to populate.
   * @return {module:model/ExpiryDate} The populated <code>ExpiryDate</code> instance.
   */
