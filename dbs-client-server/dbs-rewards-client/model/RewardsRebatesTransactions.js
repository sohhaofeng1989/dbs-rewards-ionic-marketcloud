...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RecordControl', 'model/RewardsRebatesTransaction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RecordControl'), require('./RewardsRebatesTransaction'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.RewardsRebatesTransactions = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RecordControl, root.RewardsApIs.RewardsRebatesTransaction);
  }
}(this, function(ApiClient, RecordControl, RewardsRebatesTransaction) {
  'use strict';
  ...
  /**
   * The RewardsRebatesTransactions model module.
   * @module model/RewardsRebatesTransactions
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsRebatesTransactions</code>.
   * @alias module:model/RewardsRebatesTransactions
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsRebatesTransactions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsRebatesTransactions} obj Optional instance to populate.
   * @return {module:model/RewardsRebatesTransactions} The populated <code>RewardsRebatesTransactions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('rewardsRebatesTransaction')) {
        obj['rewardsRebatesTransaction'] = ApiClient.convertToType(data['rewardsRebatesTransaction'], [RewardsRebatesTransaction]);
      }
      if (data.hasOwnProperty('recordControl')) {
        obj['recordControl'] = RecordControl.constructFromObject(data['recordControl']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/RewardsRebatesTransaction>} rewardsRebatesTransaction
   */
  exports.prototype['rewardsRebatesTransaction'] = undefined;
  /**
   * @member {module:model/RecordControl} recordControl
   */
  exports.prototype['recordControl'] = undefined;
