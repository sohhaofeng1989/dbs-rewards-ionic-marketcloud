...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.ItemImage = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.ValidityPeriod);
  }
   ...
   * @param {module:model/ItemImage} obj Optional instance to populate.
   * @return {module:model/ItemImage} The populated <code>ItemImage</code> instance.
   */
