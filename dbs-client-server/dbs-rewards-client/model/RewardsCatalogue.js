...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CatalogueItem'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CatalogueItem'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.RewardsCatalogue = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.CatalogueItem);
  }
}(this, function(ApiClient, CatalogueItem) {
  'use strict';
  ...
  /**
   * The RewardsCatalogue model module.
   * @module model/RewardsCatalogue
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsCatalogue</code>.
   * Reward Catalogue items
   * @alias module:model/RewardsCatalogue
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>RewardsCatalogue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsCatalogue} obj Optional instance to populate.
   * @return {module:model/RewardsCatalogue} The populated <code>RewardsCatalogue</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'CatalogueItem');
