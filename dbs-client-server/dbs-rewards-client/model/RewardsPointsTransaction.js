...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RewardsPointsTransaction = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The RewardsPointsTransaction model module.
   * @module model/RewardsPointsTransaction
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsPointsTransaction</code>.
   * Rewards Points Transaction details
   * @alias module:model/RewardsPointsTransaction
   * @class
  ...
  /**
   * Constructs a <code>RewardsPointsTransaction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsPointsTransaction} obj Optional instance to populate.
   * @return {module:model/RewardsPointsTransaction} The populated <code>RewardsPointsTransaction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('earnedPoints')) {
        obj['earnedPoints'] = ApiClient.convertToType(data['earnedPoints'], 'Number');
      }
      if (data.hasOwnProperty('redeemedPoints')) {
        obj['redeemedPoints'] = ApiClient.convertToType(data['redeemedPoints'], 'Number');
      }
      if (data.hasOwnProperty('adjustedPoints')) {
        obj['adjustedPoints'] = ApiClient.convertToType(data['adjustedPoints'], 'Number');
      }
  ...
  /**
   * Scheme Name. Eg. DBS Points
   * @member {String} schemeName
   */
  exports.prototype['schemeName'] = undefined;
  /**
   * Earned points
   * @member {Number} earnedPoints
   */
  exports.prototype['earnedPoints'] = undefined;
  /**
   * Redeemed points
   * @member {Number} redeemedPoints
   */
  exports.prototype['redeemedPoints'] = undefined;
  /**
   * Adjusted points
   * @member {Number} adjustedPoints
   */
  exports.prototype['adjustedPoints'] = undefined;
  /**
