...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ItemImage', 'model/Tag'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ItemImage'), require('./Tag'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.CatalogueItem = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.ItemImage, root.RewardsApIs.Tag);
  }
}(this, function(ApiClient, ItemImage, Tag) {
  'use strict';
  ...
  /**
   * The CatalogueItem model module.
   * @module model/CatalogueItem
   * @version 1.0
   */

  /**
   * Constructs a new <code>CatalogueItem</code>.
   * Catalogue item
   * @alias module:model/CatalogueItem
   * @class
   */
  ...
  /**
   * Constructs a <code>CatalogueItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CatalogueItem} obj Optional instance to populate.
   * @return {module:model/CatalogueItem} The populated <code>CatalogueItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('itemImage')) {
        obj['itemImage'] = ItemImage.constructFromObject(data['itemImage']);
      }
    }
    return obj;
  }
  ...
  /**
   * Price of the Reward Item. The price value can be Points or Amount
   * @member {Number} price
   */
  exports.prototype['price'] = undefined;
  /**
   * Tags for the Reward Item
   * @member {Array.<module:model/Tag>} tags
   */
  exports.prototype['tags'] = undefined;
  /**
   * Images for the Reward Item
   * @member {module:model/ItemImage} itemImage
   */
  exports.prototype['itemImage'] = undefined;
