...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RecordControl', 'model/RewardsPointsTransaction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RecordControl'), require('./RewardsPointsTransaction'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.RewardsPointsTransactions = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RecordControl, root.RewardsApIs.RewardsPointsTransaction);
  }
}(this, function(ApiClient, RecordControl, RewardsPointsTransaction) {
  'use strict';
  ...
  /**
   * The RewardsPointsTransactions model module.
   * @module model/RewardsPointsTransactions
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsPointsTransactions</code>.
   * @alias module:model/RewardsPointsTransactions
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsPointsTransactions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsPointsTransactions} obj Optional instance to populate.
   * @return {module:model/RewardsPointsTransactions} The populated <code>RewardsPointsTransactions</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('rewardsPointsTransaction')) {
        obj['rewardsPointsTransaction'] = ApiClient.convertToType(data['rewardsPointsTransaction'], [RewardsPointsTransaction]);
      }
  ...
  /**
   * @member {Array.<module:model/RewardsPointsTransaction>} rewardsPointsTransaction
   */
  exports.prototype['rewardsPointsTransaction'] = undefined;
  /**
