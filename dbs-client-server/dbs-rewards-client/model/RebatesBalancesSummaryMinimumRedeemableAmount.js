...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RebatesBalancesSummaryMinimumRedeemableAmount = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RebatesBalancesSummaryMinimumRedeemableAmount model module.
   * @module model/RebatesBalancesSummaryMinimumRedeemableAmount
   * @version 1.0
   */

  /**
   * Constructs a new <code>RebatesBalancesSummaryMinimumRedeemableAmount</code>.
   * Minimum Amount that can be redeemed for Rebates scheme. This will be populated if query amount is not present or exceeds the balance.
   * @alias module:model/RebatesBalancesSummaryMinimumRedeemableAmount
   * @class
   */
  ...
  /**
   * Constructs a <code>RebatesBalancesSummaryMinimumRedeemableAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RebatesBalancesSummaryMinimumRedeemableAmount} obj Optional instance to populate.
   * @return {module:model/RebatesBalancesSummaryMinimumRedeemableAmount} The populated <code>RebatesBalancesSummaryMinimumRedeemableAmount</code> instance.
   */
