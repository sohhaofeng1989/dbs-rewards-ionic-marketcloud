...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.PaymentRequestGrossAmount = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The PaymentRequestGrossAmount model module.
   * @module model/PaymentRequestGrossAmount
   * @version 1.0
   */

  /**
   * Constructs a new <code>PaymentRequestGrossAmount</code>.
   * Total bill amount of the transaction
   * @alias module:model/PaymentRequestGrossAmount
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentRequestGrossAmount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentRequestGrossAmount} obj Optional instance to populate.
   * @return {module:model/PaymentRequestGrossAmount} The populated <code>PaymentRequestGrossAmount</code> instance.
   */
