...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReversalResponseRewardsBalanceRemainingCashValue'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReversalResponseRewardsBalanceRemainingCashValue'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.ReversalResponseRewardsBalance = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.ReversalResponseRewardsBalanceRemainingCashValue);
  }
}(this, function(ApiClient, ReversalResponseRewardsBalanceRemainingCashValue) {
  'use strict';
  ...
  /**
   * The ReversalResponseRewardsBalance model module.
   * @module model/ReversalResponseRewardsBalance
   * @version 1.0
   */

  /**
   * Constructs a new <code>ReversalResponseRewardsBalance</code>.
   * Redeemable amount after reversal, breakdown by account level
   * @alias module:model/ReversalResponseRewardsBalance
   * @class
   */
  ...
  /**
   * Constructs a <code>ReversalResponseRewardsBalance</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReversalResponseRewardsBalance} obj Optional instance to populate.
   * @return {module:model/ReversalResponseRewardsBalance} The populated <code>ReversalResponseRewardsBalance</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('remainingPoints')) {
        obj['remainingPoints'] = ApiClient.convertToType(data['remainingPoints'], 'Number');
      }
      if (data.hasOwnProperty('remainingCashValue')) {
        obj['remainingCashValue'] = ReversalResponseRewardsBalanceRemainingCashValue.constructFromObject(data['remainingCashValue']);
      }
    }
    return obj;
  }
  ...
  /**
   * Points balance that is remaining.
   * @member {Number} remainingPoints
   */
  exports.prototype['remainingPoints'] = undefined;
  /**
   * @member {module:model/ReversalResponseRewardsBalanceRemainingCashValue} remainingCashValue
   */
  exports.prototype['remainingCashValue'] = undefined;
