...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RewardsAccountRewardsScheme = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RewardsAccountRewardsScheme model module.
   * @module model/RewardsAccountRewardsScheme
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsAccountRewardsScheme</code>.
   * Rewards scheme details
   * @alias module:model/RewardsAccountRewardsScheme
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsAccountRewardsScheme</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsAccountRewardsScheme} obj Optional instance to populate.
   * @return {module:model/RewardsAccountRewardsScheme} The populated <code>RewardsAccountRewardsScheme</code> instance.
   */
