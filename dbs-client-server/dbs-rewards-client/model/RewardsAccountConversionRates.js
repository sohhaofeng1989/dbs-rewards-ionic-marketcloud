...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RewardsAccountConversionRates = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RewardsAccountConversionRates model module.
   * @module model/RewardsAccountConversionRates
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsAccountConversionRates</code>.
   * Indicates conversion rate to redeem customer&#39;s Points or Rebates for the Merchant&#39;s products/services
   * @alias module:model/RewardsAccountConversionRates
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsAccountConversionRates</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsAccountConversionRates} obj Optional instance to populate.
   * @return {module:model/RewardsAccountConversionRates} The populated <code>RewardsAccountConversionRates</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pointsPerUnit')) {
        obj['pointsPerUnit'] = ApiClient.convertToType(data['pointsPerUnit'], 'Number');
      }
    }
    return obj;
  }
  ...
  /**
   * Units of currency. This is the base value for conversion
   * @member {Number} units
   */
  exports.prototype['units'] = undefined;
  /**
   * Points needs per unit value of the currency
   * @member {Number} pointsPerUnit
   */
  exports.prototype['pointsPerUnit'] = undefined;
