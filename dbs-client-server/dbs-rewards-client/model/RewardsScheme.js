...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RewardsScheme = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RewardsScheme model module.
   * @module model/RewardsScheme
   * @version 1.0
   */

  /**
   * Constructs a new <code>RewardsScheme</code>.
   * Rewards Scheme
   * @alias module:model/RewardsScheme
   * @class
   */
  ...
  /**
   * Constructs a <code>RewardsScheme</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RewardsScheme} obj Optional instance to populate.
   * @return {module:model/RewardsScheme} The populated <code>RewardsScheme</code> instance.
   */
