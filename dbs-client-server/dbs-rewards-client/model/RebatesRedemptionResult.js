...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RebatesRedemptionResult = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.Amount);
  }
  ...
  /**
   * The RebatesRedemptionResult model module.
   * @module model/RebatesRedemptionResult
   * @version 1.0
   */

  /**
   * Constructs a new <code>RebatesRedemptionResult</code>.
   * Redemption result details
   * @alias module:model/RebatesRedemptionResult
   * @class
   */
  ...
  /**
   * Constructs a <code>RebatesRedemptionResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RebatesRedemptionResult} obj Optional instance to populate.
   * @return {module:model/RebatesRedemptionResult} The populated <code>RebatesRedemptionResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transactionFee')) {
        obj['transactionFee'] = Amount.constructFromObject(data['transactionFee']);
      }
    }
    return obj;
  }
  ...
  /**
   * Transaction Fee for redemption
   * @member {module:model/Amount} transactionFee
   */
  exports.prototype['transactionFee'] = undefined;
