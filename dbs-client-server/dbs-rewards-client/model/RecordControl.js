...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RewardsApIs.RecordControl = factory(root.RewardsApIs.ApiClient);
  }
  ...
  /**
   * The RecordControl model module.
   * @module model/RecordControl
   * @version 1.0
   */

  /**
   * Constructs a new <code>RecordControl</code>.
   * Record control information
   * @alias module:model/RecordControl
   * @class
   */
  ...
  /**
   * Constructs a <code>RecordControl</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RecordControl} obj Optional instance to populate.
   * @return {module:model/RecordControl} The populated <code>RecordControl</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('matchedRecordCount')) {
        obj['matchedRecordCount'] = ApiClient.convertToType(data['matchedRecordCount'], 'Number');
      }
      if (data.hasOwnProperty('sentRecordCount')) {
        obj['sentRecordCount'] = ApiClient.convertToType(data['sentRecordCount'], 'Number');
      }
   ...
   * @member {Number} matchedRecordCount
   */
  exports.prototype['matchedRecordCount'] = undefined;
  /**
   * Number of records sent
   * @member {Number} sentRecordCount
   */
  exports.prototype['sentRecordCount'] = undefined;
  /**
