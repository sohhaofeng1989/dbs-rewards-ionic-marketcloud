...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RewardsExchangeRate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RewardsExchangeRate'));
  } else {
    // Browser globals (root is window)
    if (!root.RewardsApIs) {
      root.RewardsApIs = {};
    }
    root.RewardsApIs.ConversionRates = factory(root.RewardsApIs.ApiClient, root.RewardsApIs.RewardsExchangeRate);
  }
}(this, function(ApiClient, RewardsExchangeRate) {
  'use strict';
  ...
  /**
   * The ConversionRates model module.
   * @module model/ConversionRates
   * @version 1.0
   */

  /**
   * Constructs a new <code>ConversionRates</code>.
   * Conversion rates from Points to Cash value
   * @alias module:model/ConversionRates
   * @class
   * @extends Array
   */
  ...
  /**
   * Constructs a <code>ConversionRates</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConversionRates} obj Optional instance to populate.
   * @return {module:model/ConversionRates} The populated <code>ConversionRates</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      ApiClient.constructFromObject(data, obj, 'RewardsExchangeRate');
