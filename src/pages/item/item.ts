...
export class ItemPage {
  ...
  addToCart(product) {
    ...
    if (this.configuration.get('user-chosen')){
      let productsList= this.configuration.get('user-chosen').products;
      productsList.push(product);
      this.configuration.set('user-chosen', {products: productsList});
    }
    else
      this.configuration.set('user-chosen', JSON.stringify({products:[product]}));
